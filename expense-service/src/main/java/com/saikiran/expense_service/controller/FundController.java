...
public class FundController {
    ...
    @GetMapping
    public ResponseEntity<List<FundResponse>> getFunds(@RequestHeader("x-user-id") String userId) {
    ...
    public ResponseEntity<FundResponse> getFundById(
        ...
        FundResponse response = fundService.getFundById(userId, fundId);
        return ResponseEntity.ok(response);
    }

    @GetMapping("/analytics/utilization")
    public ResponseEntity<List<FundUtilizationResponse>> getFundUtilization(@RequestHeader("x-user-id") String userId) {
        return ResponseEntity.ok(fundService.getFundUtilization(userId));
    }
}
