...
public class DashboardService {
    ...
    public DashboardResponse getDashboard(
        ...
        Long activeFunds =
                (long) activeFundsList.size();

        // Remaining Fund Amount

        BigDecimal remainingFundAmount =
        ...
        List<FundResponse> recentFunds =

                fundRepository
                        .findTop3ByUserIdOrderByCreatedDateDesc(
                                userId
                        )
